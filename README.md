...
Download the latest <a href="https://veeva.github.io/vault-log-analyzer/maven/com/veeva/vault/vault-log-analyzer/24.2.0/vault-log-analyzer-24.2.0.jar" download>vault-log-analyzer-24.2.0.jar</a>
...
3. Download the <a href="https://veeva.github.io/vault-log-analyzer/maven/com/veeva/vault/vault-log-analyzer/24.2.0/vault-log-analyzer-24.2.0-api.xlsx" download>vault-log-analyzer-api.xlsx</a> file, and place it in the folder with the jar file
...
3. Download the <a href="https://veeva.github.io/vault-log-analyzer/maven/com/veeva/vault/vault-log-analyzer/24.2.0/vault-log-analyzer-24.2.0-debug.xlsx" download>vault-log-analyzer-debug.xlsx</a> file, and place it in the folder with the jar file
4. Open a command line, and navigate to the folder where the jar file is. Run the command below

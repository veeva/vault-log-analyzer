...
Download the latest <a href="https://veeva.github.io/vault-log-analyzer/maven/com/veeva/vault/vault-log-analyzer/23.2.0/vault-log-analyzer-23.2.0.jar" download>vault-log-analyzer-23.2.0.jar</a>
...
3. Download the <a href="https://veeva.github.io/vault-log-analyzer/maven/com/veeva/vault/vault-log-analyzer/23.2.0/vault-log-analyzer-23.2.0-api.xlsx" download>vault-log-analyzer-api.xlsx</a> file, and place it in the folder with the jar file
4. Open a command line, and navigate to the folder where the jar file is. Run the command below

```
java -jar vault-log-analyzer-23.2.0.jar -logtype API -action IMPORT
```

5. Verify that the "vault-log-analyzer.db" file was generated, then run the following command
```
java -jar vault-log-analyzer-23.2.0.jar -logtype API -action ANALYZE
```
...
3. Download the <a href="https://veeva.github.io/vault-log-analyzer/maven/com/veeva/vault/vault-log-analyzer/23.2.0/vault-log-analyzer-23.2.0-debug.xlsx" download>vault-log-analyzer-debug.xlsx</a> file, and place it in the folder with the jar file
4. Open a command line, and navigate to the folder where the jar file is. Run the command below

```
java -jar vault-log-analyzer-23.2.0.jar -logtype DEBUG -action ANALYZE
```
...
1. Import logs
```
java -jar vault-log-analyzer-23.2.0.jar -logtype API -action IMPORT -input ./path/to/logs -output ./path/to/analyze.db
```

2. Analyze .db file
```
java -jar vault-log-analyzer-23.2.0.jar -logtype API -action ANALYZE -input ./path/to/analyze.db -output ./path/to/output.csv
```

3. Download API Usage Logs
```
java -jar vault-log-analyzer-23.2.0.jar -logtype API -action DOWNLOAD -vaultDns cholecap.veevavault.com -sessionId {session ID} -startDate 2023-02-01 -endDate 2023-02-05
```
...
* Analyze logs
```
java -jar vault-log-analyzer-23.2.0.jar -logtype DEBUG -action ANALYZE -input ./path/to/logs -output ./path/to/output.csv
```
...
```
java -jar vault-log-analyzer-23.2.0.jar -logtype RUNTIME -action DOWNLOAD -vaultDns cholecap.veevavault.com -sessionId {session ID} -startDate 2023-02-01 -endDate 2023-02-05
```